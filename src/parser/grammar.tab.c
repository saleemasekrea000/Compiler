...
enum yysymbol_kind_t
{
  ...
  YYSYMBOL_34_1 = 34,                      /* $@1  */
  YYSYMBOL_assertion = 35,                 /* assertion  */
...
{
       0,    34,    34,    38,    39,    43,    50,    51,    54,    55,
      59,    60,    64,    65,    69,    70,    71,    72,    76,    77,
      81,    85,    86,    87,    88,    89,    92,    96,    97,   101,
     102,   106,   106,   112,   113,   114,   115,   120,   121
};
#endif
...
static const char *const yytname[] =
{
  ...
  "INTEGER_LITERAL", "OPERATOR", "KEYWORD", "IS", "WHILE", "ROUTINE",
  "END", "LPAR", "RPAR", "LBRAC", "RBRAC", "RELPAR", "RERLPR",
  ...
  "$@1", "assertion", "return_statement", YY_NULLPTR
};
...
{
       2,     4,    13,     0,   -12,    17,    38,   -12,    -1,    27,
     -12,    17,   -12,   -12,   -12,   -12,   -12,    15,    29,    11,
      31,    21,    45,    46,    42,   -12,    33,    44,   -12,   -12,
      10,   -12,    50,   -12,   -12,    12,   -12,    35,    37,    39,
     -12,    40,    47,   -12,    -3,    29,    -2,    48,    31,    51,
      54,    49,   -12,   -12,   -12,   -12,    17,   -12,   -12,   -12,
      52,   -12,    56,   -12,   -12,   -12,    41,    43,   -12,     9,
      55,    53,   -12,   -12,   -12,   -12,   -12,   -12,   -12
};
...
{
       0,     0,     0,     0,     3,     0,     0,     1,     0,     0,
       4,     2,    12,    14,    15,    16,    17,     0,     0,     0,
       0,     0,     0,     0,     0,    13,     0,     0,    10,    11,
       0,     8,     0,    29,    30,     0,    27,     0,     0,     0,
      31,     0,     0,     5,     0,     0,     0,     0,     0,     0,
      21,     0,    36,    34,    35,    33,     0,    37,    38,     7,
       0,     9,     0,    19,    26,    28,     0,     0,    20,     0,
       0,     0,    22,    23,    24,    25,    32,     6,    18
};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -12,   -12,   -12,    58,   -12,   -12,    18,    -4,   -11,   -12,
...
{
       0,     2,     3,     4,     5,    30,    31,    11,    12,    13,
      14,    51,    15,    35,    36,    16,    56,    24,    27
};
...
{
      25,    17,    19,     8,    59,    62,    25,     6,     9,     1,
      20,     1,     8,     7,    60,    63,    21,     9,     8,    76,
       8,    26,    44,     9,    47,     9,    37,    45,    32,    48,
      22,    23,    28,    29,    33,    34,    41,    42,    49,    50,
      52,    53,    54,    55,    72,    73,    74,    75,    40,    18,
      38,    39,    69,    46,    43,    70,    66,    57,    25,    67,
      71,    10,    77,    61,    58,    64,    68,    65,     0,     0,
      78
};
...
static const yytype_int8 yycheck[] =
{
      ...
      11,     9,     3,     0,    17,    17,    17,     8,     3,    10,
       3,     6,    12,     8,    12,     8,     5,    17,    17,    17,
       3,     4,     3,     4,     3,     4,     3,     4,     3,     4,
       3,     4,     3,     4,     3,     4,     3,     4,     6,    11,
       5,     5,    56,     3,    10,     3,     5,    17,    69,     5,
       4,     3,     7,    45,    17,    17,    17,    48,    -1,    -1,
      17
};
...
{
       0,     9,    19,    20,    21,    22,     3,     0,     3,     8,
      21,    25,    26,    27,    28,    30,    33,    25,    11,     3,
      11,    17,     3,     4,    35,    26,     6,    36,     3,     4,
      23,    24,    17,     3,     4,    31,    32,     5,     5,     5,
       6,     3,     4,    10,    12,    17,     3,    12,    17,     3,
       4,    29,     3,     4,     3,     4,    34,    17,    17,     7,
      17,    24,     7,    17,    17,    32,     5,     5,    17,    25,
       3,     4,     3,     4,     3,     4,    10,     7,    17
};
...
#line 34 "grammar.y"
                                  { print_indent(); printf("%d: Main program\n", counter++);}
#line 1145 "grammar.tab.c"
    break;

  case 3: /* routine_declarations: routine_declaration  */
#line 38 "grammar.y"
                      { print_indent(); printf("%d: List of routine declarations\n", counter++); }
...
#line 76 "grammar.y"
                                                                            { print_indent(); printf("%d: variable declaration for %s\n", counter++, (yyvsp[-5].id_val)); }
#line 1181 "grammar.tab.c"
    break;

  case 19: /* variable_declaration: IDENTIFIER IDENTIFIER PUNCTUATOR IDENTIFIER PUNCTUATOR  */
#line 77 "grammar.y"
                                                           { print_indent(); printf("%d: variable declaration for %s\n", counter++, (yyvsp[-3].id_val)); }
#line 1187 "grammar.tab.c"
    break;

  case 20: /* assignment: IDENTIFIER PUNCTUATOR OPERATOR int_expression PUNCTUATOR  */
#line 81 "grammar.y"
                                                           { print_indent(); printf("%d: assignment for %s\n", counter++, (yyvsp[-4].id_val)); }
#line 1193 "grammar.tab.c"
    break;

  case 26: /* function_call: IDENTIFIER LPAR arguments RPAR PUNCTUATOR  */
#line 92 "grammar.y"
                                            { print_indent(); printf("%d: function call for %s\n", counter++, (yyvsp[-4].id_val));}
#line 1199 "grammar.tab.c"
    break;

  case 31: /* $@1: %empty  */
#line 106 "grammar.y"
                          { print_indent(); printf("%d: while loop start\n", counter++); }
#line 1205 "grammar.tab.c"
    break;

  case 32: /* while_loop: WHILE assertion KEYWORD $@1 statements END  */
#line 108 "grammar.y"
      { print_indent(); printf("%d: while loop end\n", counter++); }
#line 1211 "grammar.tab.c"
    break;

  case 37: /* return_statement: KEYWORD IDENTIFIER PUNCTUATOR  */
#line 120 "grammar.y"
                                { print_indent(); printf("%d: return value is %s\n", counter++, (yyvsp[-1].id_val)); }
#line 1217 "grammar.tab.c"
    break;

  case 38: /* return_statement: KEYWORD INTEGER_LITERAL PUNCTUATOR  */
#line 121 "grammar.y"
                                       { print_indent(); printf("%d: return value is %d\n", counter++, (yyvsp[-1].int_val));  }
